...
<img class="common_img" src="../_static/media/chapter_4/section_3/03/media/image4.png" style="width:350px;"/>
...
(4) Click on the <img src="../_static/media/chapter_4/section_3/03/media/image10.png"  />button on the right to download the program to the controller. Wait for the "**Download Successful**" prompt to appear.
...
<img class="common_img" src="../_static/media/chapter_5/section_4/02/2.1/media/image3.png" style="width:350px;"/>
...
(4) Click on the <img src="../_static/media/chapter_4/section_4/02/image9.png"/> button on the right to download the program to the controller. Wait for the "**Upload Completed**" prompt to appear.
...
<img class="common_img" src="../_static/media/chapter_4/section_4/07/image3.png" style="width:350px;"/>
...
(4) Hit the "**Upload**" button <img src="../_static/media/chapter_4/section_5/04/media/image9.png"  /> on the right to transfer the program to the xArm AI. Wait for the confirmation that the upload is complete.
...
<img class="common_img" src="../_static/media/chapter_4/section_5/06/media/image3.png" style="width:350px;"/>
...
<img class="common_img" src="../_static/media/chapter_4/section_5/06/media/image4.png" style="width:350px;"/>
...
(1) Open the WonderCode software <img src="../_static/media/chapter_4/section_5/06/media/image6.png"  />

(2) Drag the [Adaptive Grasping & Broadcasting Program.sb3](../_static/source_code/04/Adaptive%20Grasping%20&%20Broadcasting%20Program.zip) file from the same folder as this document into WonderCode.
...
(4) Hit the **"Upload"** button <img src="../_static/media/chapter_4/section_5/06/media/image10.png"  /> on the right to transfer the program to the xArm AI. Wait for the confirmation that the upload is complete.
...
(1) Open the WonderCode software <img src="../_static/media/chapter_4/section_6/01/media/image5.png"  />.

(2) Drag the program file [Touch Control Program.sb3](../_static/source_code/04/Touch%20Control%20Program.zip) located in the same directory as this document into WonderCode.
...
<img class="common_img" src="../_static/media/chapter_4/section_6/02/media/image3.png" style="width:350px;"/>
...
<img class="common_img" src="../_static/media/chapter_4/section_6/02/media/image4.png" style="width:350px;"  />
...
(1) Open the WonderCode software <img src="../_static/media/chapter_4/section_6/02/media/image6.png"  />.

(2) Drag the program file [Dual Infrared Detection Sorting & Control Program.sb3](../_static/source_code/04/Dual%20Infrared%20Detection%20Sorting%20&%20Control%20Program.zip) located in the same directory as this document into WonderCode.
...
(4) Click on the <img src="../_static/media/chapter_4/section_6/02/media/image10.png"  /> button on the right to download the program to the controller. Wait for the "**Upload Completed**" prompt to appear.
...
<img class="common_img" src="../_static/media/chapter_4/section_6/03/media/image3.png" style="width:350px;"/>
...
<img class="common_img" src="../_static/media/chapter_4/section_6/03/media/image4.png" style="width:350px;"/>
...
(1) Open the WonderCode software <img src="../_static/media/chapter_4/section_6/03/media/image6.png"  />.

(2) Drag the program file "**[Light Sensing Control Program.sb3](../_static/source_code/04/Light%20Sensing%20Control%20Program.zip)**" located in the same directory as this document into WonderCode.
...
(4) Click on the <img src="../_static/media/chapter_4/section_6/03/media/image10.png"  /> button on the right to download the program to the controller. Wait for the "**Upload Completed**" prompt to appear.
...
<img class="common_img" src="../_static/media/chapter_4/section_6/04/media/image3.png" style="width:350px;"/>
...
<img class="common_img" src="../_static/media/chapter_4/section_6/04/media/image4.png" style="width:350px;"/>
...
(1) Open the WonderCode software <img src="../_static/media/chapter_4/section_6/04/media/image6.png"  />.

(2) Drag the program file "**[Acceleration Control Program.sb3](../_static/source_code/04/Acceleration%20Control%20Program.zip)**" located in the same directory as this document into WonderCode.
...
(4) Click on the <img src="../_static/media/chapter_4/section_6/04/media/image10.png"  /> button on the right to download the program to the controller. Wait for the "**Download Successful**" prompt to appear.
...
<img class="common_img" src="../_static/media/chapter_4/section_6/05/media/image3.png" style="width:350px;"/>
...
<img class="common_img" src="../_static/media/chapter_4/section_6/05/media/image4.png" style="width:350px;"/>
...
(1) Open the WonderCode software <img src="../_static/media/chapter_4/section_6/05/media/image6.png"  />.

(2) Drag the program file [Temperature and Humidity Display Program.sb3](../_static/source_code/04/Temperature%20and%20Humidity%20Display%20Program.zip) located in the same directory as this document into WonderCode.
...
(4) Click on the <img src="../_static/media/chapter_4/section_6/05/media/image10.png"  /> button on the right to download the program to the controller. Wait for the "**Upload Completed**" prompt to appear.
...
<img class="common_img" src="../_static/media/chapter_4/section_6/06/media/image3.png" style="width:350px;"/>
...
<img class="common_img" src="../_static/media/chapter_4/section_6/06/media/image4.png" style="width:350px;"/>
...
(1) Open the WonderCode software <img src="../_static/media/chapter_4/section_6/06/media/image6.png"  />.

(2) Drag the program file "**[Temperature and Humidity + Fan Control Program.sb3](../_static/source_code/04/Temperature%20and%20Humidity%20+%20Fan%20Control%20Program.zip)**" located in the same directory as this document into WonderCode.
...
(4) Click on the <img src="../_static/media/chapter_4/section_6/06/media/image10.png"  /> button on the right to download the program to the controller. Wait for the "**Upload Completed**" prompt to appear.
...
<img class="common_img" src="../_static/media/chapter_4/section_6/07/media/image3.png" style="width:350px;"/>
...
<img class="common_img" src="../_static/media/chapter_4/section_6/07/media/image4.png" style="width:350px;"/>
...
(1) Open the WonderCode software <img src="../_static/media/chapter_4/section_6/07/media/image6.png"  />.

(2) Drag the program file [Face Recognition + Fan Tracking Program.sb3](../_static/source_code/04/Face%20Recognition%20+%20Fan%20Tracking%20Program.zip) located in the same directory as this document into WonderCode.
...
(4) Click on the <img src="../_static/media/chapter_4/section_6/07/media/image10.png"  /> button on the right to download the program to the controller. Wait for the "**Upload Completed**" prompt to appear.
