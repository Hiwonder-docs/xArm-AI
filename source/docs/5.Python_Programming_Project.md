...
(2) Select [Appendix/Program Collection/Python Project Programs](resources_download.md) and click the '**Select Folder**' button.
...
Here, we can double-click on the program file in the file list to view the detailed code. For example, let's take [ '***\*mart_fan.py\****:](../_static/source_code/05/smart_fan.zip):
...
:::{Note}
* The development software WonderCode used in the xarm Scratch programming project integrates the font generation software for the corresponding dot matrix module. You can refer to the program and documentation in "[**4. Scratch Programming Projects->4.3 Basic Project Course->4.3.1 Dot Matrix Display**](4.Scratch_Programming_Project.md#dot-matrix-display)" to learn more.
...
<img class="common_img" src="../_static/media/chapter_5/section_3/03/media/image4.png" style="width:350px;"/>
