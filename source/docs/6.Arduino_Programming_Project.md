...
(2) In the pop-up window, locate the [xArm_AI.zip]() file (the library file compression package can be found in the [6. Arduino Programming Projects->6.1 Programming Tool Installation and Overview_Demo]() folder) and click Open.
