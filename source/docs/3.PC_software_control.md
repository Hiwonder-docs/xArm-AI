...
(1) Open the program file in [PC Software Installation Package](resources_download.md).
...
(2) Click the "**Open Action File**" button, and select the action file named **"No. 2 – Grab and Move to Left 90°"** under [Appendix -> 2.6 Action Group Files](resources_download.md).
...
③ Executing action groups via serial commands (see [7. Serial Communication Lesson](7.Serial_Communication_Course.md))
...
(1)  Switch on the robotic arm. Then connect it to the computer and open PC software.
...
Step 1: Open the PC software, and connect the serial port. Click "**Integrate file**", and open the action group NO.0 located in [Appendix -\>Action Group Files](resources_download.md).
...
Step 3: Click **"Integrate file"** again and choose action group NO.2 for integration.

<img class="common_img" src="../_static/media/chapter_3/section_4/media/image4.png"  />

Step 4: Click "**Run**" to execute the new integrated actions online.

<img class="common_img" src="../_static/media/chapter_3/section_4/media/image5.png"  />

Step 5: Click **"Save action file"** to save the new integrated action group for the future debugging.
...
(2) Open an action group file in folder "[**Appendix-\>Action Group Files**](resources_download.md)" . For example, **"04"** action group.
